...
public class ExclusionBeforeExecutionFileFilterTest extends BaseCheckTestSupport {
    ...
    public void testAccept() {
        ...
        final BeforeExecutionFileFilterEvent ev =
                new BeforeExecutionFileFilterEvent(this, "ATest.java");
    ...
    public void testAcceptOnNullFile() {
        ...
        final BeforeExecutionFileFilterEvent ev =
                new BeforeExecutionFileFilterEvent(this, "AnyJava.java");
    ...
    public void testRejectBadFile() throws Exception {
        ...
        filterConfig.addAttribute("fileName", "IncorrectClass\\.java");
    ...
    private static BeforeExecutionExclusionFileFilter
        ...
        if (fileName != null) {
            exclusionBeforeExecutionFileFilter.setFileName(fileName);
        }
