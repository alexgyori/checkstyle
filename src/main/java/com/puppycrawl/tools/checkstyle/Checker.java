...
public class Checker extends AutomaticBean implements MessageDispatcher {
    ...
    private void processFiles(List<File> files) throws CheckstyleException {
        for (final File file : files) {
            try {
                ...
                final SortedSet<LocalizedMessage> fileMessages = processFile(file, fileName);
     ...
     * @throws CheckstyleException if error condition within Checkstyle occurs.
     */
    private SortedSet<LocalizedMessage> processFile(File file, String fileName) throws CheckstyleException {
